...
function fetchAndDisplayRandomVillager() {
    card.innerHTML = `<div id="loading-spinner"><div>`;
    fetch('https://api.nookipedia.com/villagers?game=nh&nhdetails=true', {headers: {'X-API-KEY': '9c048400-948a-4ae7-931e-a6259fd320ba'}})
...
function getRandomVillager(array) {
    let randomNumber = Math.floor(Math.random() * 413);
